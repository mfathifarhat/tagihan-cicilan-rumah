                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" name="name" value="{{ $user->name }}" id="nama" class="form-control form-control-solid">
                            @error('name')
                        ...
                        <div class="form-group mt-2">
                            ...
                            <input type="text" name="email" value="{{ $user->email }}" id="email" class="form-control form-control-solid">
                            @error('email')
                                <div class="text-danger">{{ $message }}</div>
                            @enderror
                        </div>
