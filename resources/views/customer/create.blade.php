            ...
            <form action="" method="post">
                ...
                <div class="row" id="data-rumah">
                    ...
                    <div class="col-md-12">
                        ...
                        <input type="text" name="blok_rumah" readonly id="blok_rumah" class="form-control disabled form-control-solid" value="{{ old('blok_rumah') }}">
                        @error('blok_rumah')
                            <div class="text-danger">{{ $message }}</div>
                        @enderror
                    </div>
                ...
                <div class="row" id="data-cicilan">
                    <div class="col-md-6">
                        <div class="form-group mt-2">
                            <label for="harga_properti" class="form-label fs-14 fw-medium">Total Harga (Harga + 15%)
                                <span></span></label>
                        ...
                        <div class="form-group mt-2">
                            <label for="dp" class="form-label fs-14 fw-medium">Uang Muka (20%) <span></span></label>
                ...
                <div class="d-flex align-items-center justify-content-end gap-2">
                    ...
                    <button class="btn btn-sm btn-primary fw-medium border-0">Next</button>
                </div>
            </form>
        </div>
    </div>
