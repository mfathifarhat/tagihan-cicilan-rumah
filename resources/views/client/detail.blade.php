        ...
        <div class="card-body">
            ...
            <div class="row">
                ...
                <div class="col-md-10">
                    @switch($pembayaran->status)
                        @case('Sedang Diproses')
                            <div class="badge py-2 fs-6 text-primary bg-primary-subtle">{{ $pembayaran->status }}</div>
                        @break

                        @case('Berhasil')
                            <div class="badge py-2 fs-6 text-success bg-success-subtle">{{ $pembayaran->status }}</div>
                        @break

                        @default
                            <div class="badge py-2 fs-6 text-danger bg-danger-subtle">{{ $pembayaran->status }}</div>
                    @endswitch
                </div>
                ...
                <div class="col-md-10 mt-2">
                    <div>{{ $pembayaran->ket ? $pembayaran->ket : 'Tidak ada keterangan' }}</div>
                </div>
            </div>
